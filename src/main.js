...
const headerBrand = document.querySelector('.mobile-brand'); headerBrand.outerHTML = '<a class="header-brand" href="#" aria-label="MM Saez Corretora de Imóveis"><img src="./brand/mm-saez-sand.png" alt="MM Saez Corretora de Imóveis"></a>'
...
function siteFooter() {
  ...
  <div class="footer-inner">
    ...
    <div class="footer-contact">
      <a class="footer-brand" href="#" aria-label="M Saez Corretora de Imóveis"><img src="./brand/mm-saez-sand.png" alt="M Saez Corretora de Imóveis" /></a>
